...
def build_toy_dataset():
    ...
    # dataset = np.concatenate([x1_all, x2_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, x3_all, y_all], axis=1)
