...
#        ]
#
# plt.scatter(size, cpu, label='cpu')
# plt.scatter(size, gpu, label='gpu')
# plt.legend()
# plt.xlabel('# of nodes in the graph')
# plt.ylabel('lrp runtime (sec)')
# plt.savefig('lrp_mlpf_runtime.pdf')


#
# size = [1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 50]
# cpu = [113.29511785507202
#        ]
# gpu = [
#        ]
#
