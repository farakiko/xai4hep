...
class LRP_captum(GradientAttribution):
    """
    Copied from CAPTUM... added BatchNorm1d as a supported layer with EpsilonRule, and nn.Sigmoid as a supported non-linear layer
